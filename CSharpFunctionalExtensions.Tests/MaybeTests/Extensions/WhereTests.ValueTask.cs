...
namespace CSharpFunctionalExtensions.Tests.MaybeTests.Extensions
{
    ...
    {
        [Fact]
        public async Task Where_ValueTask_returns_value_if_predicate_returns_true()
        {
        ...
        [Fact]
        public async Task Where_ValueTask_returns_no_value_if_predicate_returns_false()
        {
            Maybe<T> maybe = T.Value;
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task Where_ValueTask_returns_no_value_if_initial_maybe_is_null(bool predicateResult)
        {
            Maybe<T> maybe = null;
