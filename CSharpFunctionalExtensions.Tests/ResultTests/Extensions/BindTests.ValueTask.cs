...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    ...
    {
        [Fact]
        public async Task Bind_ValueTask_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_K_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_K_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_K_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_K_E_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_E_selects_new_UnitResult()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_T_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_E_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_E_selects_new_UnitResult()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_E_returns_UnitResult_failure_and_does_not_execute_func()
        {
