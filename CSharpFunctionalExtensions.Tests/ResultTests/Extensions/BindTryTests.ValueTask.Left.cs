...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class BindTryTests_ValueTask_Left : BindTryTestsBase
    {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_on_valuetask_success_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_on_valuetask_failure_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_on_valuetask_success_returns_failure()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_func_on_valuetask_success_returns_failure_with_exception_message()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_func_on_valuetask_success_with_custom_error_handler_returns_failure_with_custom_message()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_on_valuetask_success_returns_success()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_on_valuetask_failure_returns_failure()
        {
            ValueTask<Result> sut = Result.Failure(ErrorMessage).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_K_on_valuetask_success_returns_failure()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_func_K_on_valuetask_success_returns_failure_with_exception_message()
        {
            ValueTask<Result> sut = Result.Success().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_on_valuetask_success_T_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_on_valuetask_success_T_returns_failure()
        {
            ValueTask<Result<T>> sut = Result.Success(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_func_on_valuetask_success_T_returns_failure_with_exception_message()
        {
            ValueTask<Result<T>> sut = Result.Success(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_on_valuetask_success_T_returns_success()
        {
            ValueTask<Result<T>> sut = Result.Success(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_on_valuetask_failure_T_returns_failure()
        {
            ValueTask<Result<T>> sut = Result.Failure<T>(ErrorMessage).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_K_on_valuetask_success_T_returns_failure()
        {
            ValueTask<Result<T>> sut = Result.Success(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_func_K_on_valuetask_success_T_returns_failure_with_exception_message()
        {
            ValueTask<Result<T>> sut = Result.Success(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_E_on_valuetask_success_T_E_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_E_on_valuetask_failure_T_E_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_E_on_valuetask_success_T_E_returns_failure()
        {
            ValueTask<Result<T, E>> sut = Result.Success<T, E>(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_E_on_valuetask_success_T_E_returns_success()
        {
            ValueTask<Result<T, E>> sut = Result.Success<T, E>(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_K_E_on_valuetask_failure_T_E_returns_failure()
        {
            ValueTask<Result<T, E>> sut = Result.Failure<T, E>(E.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_K_E_on_valuetask_success_T_E_returns_failure()
        {
            ValueTask<Result<T, E>> sut = Result.Success<T, E>(T.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_T_E_on_valuetask_success_E_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_T_E_on_valuetask_failure_E_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_T_E_on_valuetask_success_E_returns_failure()
        {
            ValueTask<UnitResult<E>> sut = UnitResult.Success<E>().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_E_on_valuetask_success_E_returns_success()
        {
            ValueTask<UnitResult<E>> sut = UnitResult.Success<E>().AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_success_E_on_valuetask_failure_E_returns_failure()
        {
            ValueTask<UnitResult<E>> sut = UnitResult.Failure(E.Value).AsValueTask();
        ...
        [Fact]
        public async Task BindTry_execute_func_returning_failure_E_on_valuetask_success_E_returns_failure()
        {
            ValueTask<UnitResult<E>> sut = UnitResult.Success<E>().AsValueTask();
