...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class BindTryTests_ValueTask_Right : BindTryTestsBase
    {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_on_success_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_on_failure_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_on_success_returns_failure()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_valuetask_func_on_success_returns_failure_with_exception_message()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_on_success_returns_success()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_on_failure_returns_failure()
        {
            Result sut = Result.Failure(ErrorMessage);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_K_on_success_returns_failure()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_valuetask_func_K_on_success_returns_failure_with_exception_message()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_throwing_valuetask_func_K_on_success_with_custom_error_handler_returns_failure_with_custom_message()
        {
            Result sut = Result.Success();
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_T_on_success_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_T_on_failure_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_T_on_success_returns_failure()
        {
            Result<T> sut = Result.Failure<T>(ErrorMessage);
        ...
        [Fact]
        public async Task BindTry_execute_throwing_valuetask_func_on_success_T_returns_failure_with_exception_message()
        {
            Result<T> sut = Result.Success(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_on_success_T_returns_success()
        {
            Result<T> sut = Result.Success(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_on_failure_T_returns_failure()
        {
            Result<T> sut = Result.Failure<T>(ErrorMessage);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_K_on_success_T_returns_failure()
        {
            Result<T> sut = Result.Success(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_throwing_valuetask_func_K_on_success_T_returns_failure_with_exception_message()
        {
            Result<T> sut = Result.Success(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_E_on_success_T_E_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_E_on_failure_T_E_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_E_on_success_T_E_returns_failure()
        {
            Result<T, E> sut = Result.Success<T, E>(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_E_on_success_T_E_returns_success()
        {
            Result<T, E> sut = Result.Success<T, E>(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_K_E_on_failure_T_E_returns_failure()
        {
            Result<T, E> sut = Result.Failure<T, E>(E.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_K_E_on_success_T_E_returns_failure()
        {
            Result<T, E> sut = Result.Success<T, E>(T.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_T_E_on_success_E_returns_success()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_T_E_on_failure_E_returns_failure()
        {
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_T_E_on_success_E_returns_failure()
        {
            UnitResult<E> sut = UnitResult.Success<E>();
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_E_on_success_E_returns_success()
        {
            UnitResult<E> sut = UnitResult.Success<E>();
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_success_E_on_failure_E_returns_failure()
        {
            UnitResult<E> sut = UnitResult.Failure(E.Value);
        ...
        [Fact]
        public async Task BindTry_execute_valuetask_func_returning_failure_E_on_success_E_returns_failure()
        {
            UnitResult<E> sut = UnitResult.Success<E>();
