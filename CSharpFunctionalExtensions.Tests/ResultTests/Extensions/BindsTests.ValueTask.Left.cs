...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    ...
    {
        [Fact]
        public async Task Bind_ValueTask_Left_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_K_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_K_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_K_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_K_E_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_E_selects_new_UnitResult()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_T_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_E_selects_new_result()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_E_returns_failure_and_does_not_execute_func()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_E_selects_new_UnitResult()
        {
        ...
        [Fact]
        public async Task Bind_ValueTask_Left_E_returns_UnitResult_failure_and_does_not_execute_func()
        {
