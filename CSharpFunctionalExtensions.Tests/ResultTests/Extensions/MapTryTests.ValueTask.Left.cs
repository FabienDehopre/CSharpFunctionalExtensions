...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapTryTests_ValueTask_Left : MapTryTestsBase
    {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_success_returns_success()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_failure_returns_failure()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_success_T_returns_success()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_failure_T_returns_failure()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_T_K_on_valuetask_success_T_E_returns_success()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_T_K_on_valuetask_failure_T_E_returns_failure()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_success_E_returns_success()
        {
        ...
        [Fact]
        public async Task MapTry_execute_func_K_on_valuetask_failure_E_returns_failure()
        {
