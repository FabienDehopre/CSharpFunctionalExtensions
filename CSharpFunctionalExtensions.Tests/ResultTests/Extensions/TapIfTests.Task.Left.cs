...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class TapIfTests_Task_Left : TapIfTestsBase
    {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public async Task TapIf_Task_Left_T_E_executes_action_conditionally_and_returns_self(bool isSuccess, bool condition)
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public async Task TapIf_Task_Left_T_E_executes_action_T_conditionally_and_returns_self(bool isSuccess, bool condition)
        {
            Result<T, E> result = Result.SuccessIf(isSuccess, T.Value, E.Value);
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public async Task TapIf_Task_Left_T_E_executes_action_per_predicate_and_returns_self(bool isSuccess, bool condition)
        {
        ...
        [InlineData(false, true)]
        [InlineData(false, false)]
        public async Task TapIf_Task_Left_T_E_executes_action_T_per_predicate_and_returns_self(bool isSuccess, bool condition)
        {
            Result<bool, E> result = Result.SuccessIf(isSuccess, condition, E.Value);
